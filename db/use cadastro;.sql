...
-- FROM      gafanhotos
-- WHERE     BINARY LEFT (nome, 1) = 'G'; -- filtra nas linhas a partir de uma condição que seta a coluna nome
-- SELECT    DISTINCT nome
-- FROM      gafanhotos;
...
-- FROM      cursos
-- ORDER BY  ano DESC,nome DESC,carga;
...
-- SELECT nome ,ano
-- FROM   cursos
-- WHERE ano > 2015 AND ano < 2018 -- retirando o 2015 e 2018 da consulta
-- ORDER BY ano DESC;
-- SELECT * 
-- FROM cursos
-- WHERE nome = 'PHP';
